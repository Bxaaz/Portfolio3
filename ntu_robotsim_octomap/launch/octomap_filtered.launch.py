...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'frame_id',
            default_value='odom',
            description='Global frame for OctoMap'
        ),
        ...
        DeclareLaunchArgument(
            ...
            default_value='0.04',
            description='Max distance from ground plane'
        ),

        DeclareLaunchArgument(
            'ground_filter/angle',
            default_value='0.15',
            description='Max angle deviation from horizontal (rad)'
        ),

        DeclareLaunchArgument(
            'ground_filter/plane_distance',
            default_value='0.07',
            description='Plane distance threshold'
        ),
